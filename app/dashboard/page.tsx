                ...
                <table className="w-full text-left">
                  <thead >
                    <tr className="border-b border-gray-300">
                      <th className="px-2 pt-2 pb-[0.8rem] font-medium text-[1.1rem]">Username</th>
                  ...
                  <tbody>
                    {
                      tableData.map((data, index) => (
                        // <Link className="w-full" href={`/dashboard/${data.id}`}>
                          <tr onClick={(e) => tableActions(e, 'view table', data.id)} key={index} className="w-full hover:bg-indigo-300 cursor-pointer">
